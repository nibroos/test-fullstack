<template>
  <div>
    ...
    <Head>
      <Title>Memulai aplikasi.. • Test Fullstack Nibros</Title>
    </Head>
    <div class="h-screen w-screen bg-zinc-50 dark:bg-zinc-900 flex flex-col">
      ...
      <div class="flex flex-col justify-center items-center h-screen">
        ...
        <p class="w-full text-center text-zinc-500 dark:text-white mt-1">Tunggu sebentar, aplikasi sedang dimuat.</p>
      </div>
    </div>
  </div>
</template>